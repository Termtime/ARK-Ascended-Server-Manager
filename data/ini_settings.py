...
INI_SETTINGS_MISC: list = [
    ...
    ("gus", _SS, "MaxPlatformSaddleStructureLimit", "Max Rafts / Platform Saddles", "Rafts and platform saddles allowed on the whole map, not structures per raft (ASE setting; ASA support unconfirmed).", "int", "75", 0, 5000, 5),
    ("gus", _SS, "MaxGateFrameOnSaddles", "Max Gateways On Saddles", "Gateways allowed on each platform saddle; not retroactive (ASE setting; ASA support unconfirmed).", "int", "0", 0, 50, 1),
    ...
    ("gus", _SS, "EnableCryoSicknessPVE", "Cryo Sickness (PvE)", "Cryo sickness when releasing a cryopodded tame. Off = no sickness. PvE only; ASA has no PvP toggle.", "bool", "True", 0, 1),
...
INI_SETTINGS_STRUCTURES: list = [
    ...
    ("game", _GM, "bDisableStructurePlacementCollision", "Disable Placement Collision", "Removes the Obstructed check, so structures can clip into terrain and into other structures. Line of sight can still block some placements.", "bool", "False", 0, 1),
